...
return (
    <div>
        <div  className="hero">
            ...
            <button onClick={() => window.location.href = '/events'}>Explore Now</button>
        </div>
        ...
        <div className="featured-events">
            ...
            <img src={movieImage} alt="Event 1" />
                ...
                <button onClick={() => window.location.href = '/events'}>Get Tickets</button>
            </div>
            ...
            <div className="event-card">
                ...
                <p>Immerse yourself in timeless Drama.</p>
                <button onClick={() => window.location.href = '/events'}>Get Tickets</button>
            </div>
        </div>
    </div>
